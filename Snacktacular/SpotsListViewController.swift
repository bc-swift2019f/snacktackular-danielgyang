...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spots.spotArray.append(Spot(name: "Shake Shack", address: "Street 1", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
